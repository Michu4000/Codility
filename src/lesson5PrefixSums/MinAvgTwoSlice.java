...
public class MinAvgTwoSlice {
	...
	public static int solution(int[] A) {
		...
		float minAvg = (float) (A[0] + A[1]) / 2; // check avg of first two values in array
		int result = 0;
		...
		for (int i = 0; i < A.length - 1; i++) {
			...
			float tempAvg = (float) (A[i] + A[i + 1]) / 2;
